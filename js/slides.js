      ...
      if ($el.hasClass('clickable') || $el.hasClass('autoplay')){
        $el.on('click next', function(){
          ...
          var $el = $(this),
              ...
              $nextElement = $selected.nextOrFirst(),
          ...
          switch ($nextElement.attr('data-id')) {
            case '1':

              $('.btn1').css('filter', 'grayscale(0)').addClass('zIndex');
              $('.btn2').css('filter', 'grayscale(1)').removeClass('zIndex');
              $('.btn3').css('filter', 'grayscale(1)').removeClass('zIndex');

              break;
            case '2':

              $('.btn1').css('filter', 'grayscale(1)').removeClass('zIndex');
              $('.btn2').css('filter', 'grayscale(0)').addClass('zIndex');
              $('.btn3').css('filter', 'grayscale(1)').removeClass('zIndex');
            ...
            default:
              ...
              $('.btn3').css('filter', 'grayscale(0)').addClass('zIndex');
